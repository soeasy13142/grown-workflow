...
封装 [ECC（Enhanced Claude Capabilities）](https://github.com/affaan-m/ECC) 的精选命令，附带项目本地约定与编排指南。提供 `/ecc:plan`、`/tdd`、`/ecc:code-review`、`/ecc:build-fix`、`/ecc:refactor-clean`、`/e2e`、`/ecc:test-coverage`、`/ecc:update-docs` 等命令。
...
按笔记类型自动补充 Dataview 查询、Mermaid 图表、语义化 Callout、别名等 Obsidian 高级功能。根据目录和文件名识别类型（HCIP / HCIA / RHEL / Index / Python / General），按类型应用不同增强套件。
...
### consolidating-docs — 文档规范化

当项目文档出现结构漂移时执行规范化：精简 CLAUDE.md（≤200 行）、将 CONTRIBUTING.md 移至根目录、清理 git 跟踪的 agent 工作文件、修复跨文件引用。

**链接** — [skill 文档](skills/consolidating-docs/SKILL.md)
